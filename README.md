...
## Environments
- Preview: https://main--kg-eds-xwalk--kratiGrg.aem.page/
- Live: https://main--kg-eds-xwalk--kratiGrg.aem.live/
...
1. Open the `kg-eds-xwalk` directory in your favorite IDE and start coding :)
